---
title: Převést ATT na STL prostřednictvím C# 
url: /cs/net/conversion/att-to-stl/ 
description: Ukázkový kód pro konverzi ATT na STL C#. Použijte API ukázkový kód pro dávkový převod souborů ATT na STL v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ATT na STL prostřednictvím C#" h2="Vykreslit ATT jako STL bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ATT na STL pomocí C#" %}}

 Abychom převedli ATT na STL, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi ATT na STL prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory ATT na STL pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ATT pomocí konstruktoru třídy Scene1. Vytvořte instanci AmfSaveOptions1. Nastavte STL konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru STL a objektem StlSaveOptions1. Zkontrolujte výsledný soubor STL v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi ATT na STL C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod ATT na STL" sectionDescription="Podívejte se na naše živé ukázky [Konverze ATT na STL](https://products.aspose.app/3d/conversion) s následujícími výhodami." >}}
