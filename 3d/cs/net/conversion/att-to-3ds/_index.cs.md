---
title: Převést ATT na 3DS prostřednictvím C# 
url: /cs/net/conversion/att-to-3ds/ 
description: Ukázkový kód pro konverzi ATT na 3DS C#. Použijte API ukázkový kód pro dávkový převod souborů ATT na 3DS v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést ATT na 3DS prostřednictvím C#" h2="Vykreslit ATT jako 3DS bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ATT na 3DS pomocí C#" %}}

 Abychom převedli ATT na 3DS, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi ATT na 3DS prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory ATT na 3DS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ATT pomocí konstruktoru třídy Scene1. Vytvořte instanci AmfSaveOptions1. Nastavte 3DS konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru 3DS a objektem Discreet3dsSaveOptions1. Zkontrolujte výsledný soubor 3DS v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi ATT na 3DS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod ATT na 3DS" sectionDescription="Podívejte se na naše živé ukázky [Konverze ATT na 3DS](https://products.aspose.app/3d/conversion) s následujícími výhodami." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Okamžitě získáte odkaz ke stažení výsledného souboru 3DS." >}}
