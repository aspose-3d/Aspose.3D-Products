...
{{% blocks/products/pf/agp/content h2="Jak převést ATT na PLY pomocí C#" %}}
 ...
 Abychom převedli ATT na PLY, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi ATT na PLY prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory ATT na PLY pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ATT pomocí konstruktoru třídy Scene1. Vytvořte instanci AmfSaveOptions1. Nastavte PLY konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru PLY a objektem PlySaveOptions1. Zkontrolujte výsledný soubor PLY v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi ATT na PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod ATT na PLY" sectionDescription="Podívejte se na naše živé ukázky [Konverze ATT na PLY](https://products.aspose.app/3d/conversion) s následujícími výhodami." >}}
