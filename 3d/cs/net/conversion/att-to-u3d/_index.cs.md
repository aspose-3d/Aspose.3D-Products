...
{{% blocks/products/pf/agp/content h2="Jak převést ATT na U3D pomocí C#" %}}
 ...
 Abychom převedli ATT na U3D, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi ATT na U3D prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory ATT na U3D pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor ATT pomocí konstruktoru třídy Scene1. Vytvořte instanci AmfSaveOptions1. Nastavte U3D konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru U3D a objektem U3dSaveOptions1. Zkontrolujte výsledný soubor U3D v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi ATT na U3D C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod ATT na U3D" sectionDescription="Podívejte se na naše živé ukázky [Konverze ATT na U3D](https://products.aspose.app/3d/conversion) s následujícími výhodami." >}}
