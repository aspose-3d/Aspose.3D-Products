---
title: Converti ATT in 3DS tramite C# 
url: /it/net/conversion/att-to-3ds/ 
description: Codice di esempio per la conversione da ATT a 3DS C#. Utilizza API codice di esempio per la conversione batch di file ATT in 3DS all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti ATT in 3DS tramite C#" h2="Rendi ATT come 3DS senza alcun 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire ATT in 3DS utilizzando C#" %}}

 Per convertire ATT in 3DS, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire ATT in 3DS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET i programmatori possono caricare e convertire facilmente ATT file in 3DS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file ATT tramite il costruttore della classe Scene1. Crea un'istanza di AmfSaveOptions1. Imposta 3DS proprietà specifiche per la conversione avanzata1. Chiama il metodo Scene.Save1. Passa il percorso di output con 3DS estensione file e oggetto di Discreet3dsSaveOptions1. Controlla il file 3DS risultante nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da ATT a 3DS C#" offSpacer="" %}}

```cs
// carica ATT in un oggetto di Scene 
var document = new Aspose.ThreeD.Scene("template.att");
// creare un'istanza di Discreet3dsSaveOptions 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire ATT in 3DS" sectionDescription="Controlla le nostre demo dal vivo per [conversione da ATT a 3DS](https://products.aspose.app/3d/conversion) con i seguenti vantaggi." >}}
