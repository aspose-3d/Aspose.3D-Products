---
title: Compress 3MF File Formats via Node.js
weight: 830
url: /nodejs-java/compression/3mf/
description: Sample Node.js compression code for 3MF file. Use this example code to compress 3MF file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress 3MF via Node.js" h2="Build your own Node.js apps to compress 3MF files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="3MF" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress 3MF File Using Node.js" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Compress 3MF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D makes it easy for the developers to compress the 3MF file with just few lines of code.
