---
title: Compress PDF File Formats via Node.js
weight: 830
url: /nodejs-java/compression/pdf/
description: Sample Node.js compression code for PDF file. Use this example code to compress PDF file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress PDF via Node.js" h2="Build your own Node.js apps to compress PDF files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress PDF File Using Node.js" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Compress PDF via Node.js" %}}
