---
title: Compress DRC File Formats via Node.js
weight: 830
url: /nodejs-java/compression/drc/
description: Sample Node.js compression code for DRC file. Use this example code to compress DRC file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress DRC via Node.js" h2="Build your own Node.js apps to compress DRC files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress DRC File Using Node.js" %}}

 In order to compress DRC file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Compress DRC via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D makes it easy for the developers to compress the DRC file with just few lines of code.
