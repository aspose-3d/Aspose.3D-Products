---
title: Convert 3DS to OBJ via Node.js 
weight: 1090
url: /nodejs-java/conversion/3ds-to-obj/ 
description: Sample code for 3DS to OBJ Node.js conversion. Aspose.3D for Node.js via Java is a standalone API that does not require the installation of any other software.Convert batch 3DS files to OBJ using API sample code.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert 3DS to OBJ via Node.js" h2="Render 3DS as OBJ without any 3D modeling and rendering software." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert 3DS to OBJ Using Node.js" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert 3DS to OBJ via Node.js" %}}
...
{{< blocks/products/pf/agp/demobox-app url="https://products.aspose.app/3d/conversion/3ds-to-obj/embed&h1&h2&nodejs-java">}}
