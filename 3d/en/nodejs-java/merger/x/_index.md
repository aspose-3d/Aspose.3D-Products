---
title: Merge X File Formats via Node.js
weight: 830
url: /nodejs-java/merger/x/
description: Sample Node.js merger code for X file. Use this example code to merge X file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge X Formats via Node.js" h2="Build your own Node.js apps to merge X files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="X" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge X File Using Node.js" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge X via Node.js" %}}
