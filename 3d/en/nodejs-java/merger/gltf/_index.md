---
title: Merge GLTF File Formats via Node.js
weight: 830
url: /nodejs-java/merger/gltf/
description: Sample Node.js merger code for GLTF file. Use this example code to merge GLTF file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge GLTF Formats via Node.js" h2="Build your own Node.js apps to merge GLTF files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge GLTF File Using Node.js" %}}

 In order to merge GLTF file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge GLTF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D makes it easy for the developers to merge the GLTF file with just few lines of code.

{{% /blocks/products/pf/agp/text %}}

-  Merge multiple GLTF files by looping
