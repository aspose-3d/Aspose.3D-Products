---
title: Merge DAE File Formats via Node.js
weight: 830
url: /nodejs-java/merger/dae/
description: Sample Node.js merger code for DAE file. Use this example code to merge DAE file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge DAE Formats via Node.js" h2="Build your own Node.js apps to merge DAE files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge DAE File Using Node.js" %}}

 In order to merge DAE file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge DAE via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D makes it easy for the developers to merge the DAE file with just few lines of code.

{{% /blocks/products/pf/agp/text %}}

-  Merge multiple DAE files by looping
