---
title: Merge 3DS File Formats via Node.js
weight: 830
url: /nodejs-java/merger/3ds/
description: Sample Node.js merger code for 3DS file. Use this example code to merge 3DS file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge 3DS Formats via Node.js" h2="Build your own Node.js apps to merge 3DS files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge 3DS File Using Node.js" %}}

 In order to merge 3DS file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge 3DS via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D makes it easy for the developers to merge the 3DS file with just few lines of code.

{{% /blocks/products/pf/agp/text %}}

-  Merge multiple 3DS files by looping
