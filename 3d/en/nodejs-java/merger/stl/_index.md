---
title: Merge STL File Formats via Node.js
weight: 830
url: /nodejs-java/merger/stl/
description: Sample Node.js merger code for STL file. Use this example code to merge STL file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge STL Formats via Node.js" h2="Build your own Node.js apps to merge STL files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge STL File Using Node.js" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge STL via Node.js" %}}
