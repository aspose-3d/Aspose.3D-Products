---
title: Merge PDF File Formats via Node.js
weight: 830
url: /nodejs-java/merger/pdf/
description: Sample Node.js merger code for PDF file. Use this example code to merge PDF file within any Web based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge PDF Formats via Node.js" h2="Build your own Node.js apps to merge PDF files using server-side APIs." logoImageSrc="/3d/aspose_3d-for-nodejs.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.3D" subTitlepfName="for Node.js" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge PDF File Using Node.js" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge PDF via Node.js" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D makes it easy for the developers to merge the PDF file with just few lines of code.

{{% /blocks/products/pf/agp/text %}}

-  Merge multiple PDF files by looping
