...
{{% blocks/products/pf/agp/content h2="Comment convertir ATT en GLTF en utilisant C#" %}}

 Afin de convertir ATT en GLTF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ATT en GLTF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les programmeurs .NET peuvent facilement charger et convertir des fichiers ATT en GLTF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ATT via le constructeur de la classe Scene1. Créer une instance de AmfSaveOptions1. Définir GLTF propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier GLTF et l'objet de GltfSaveOptions1. Vérifier le fichier GLTF résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion ATT à GLTF C#" offSpacer="" %}}
...
// enregistrer ATT en tant que GLTF 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ATT en GLTF" sectionDescription="Consultez nos démos en direct pour [Conversion ATT à GLTF](https://products.aspose.app/3d/conversion) avec les avantages suivants." >}}
