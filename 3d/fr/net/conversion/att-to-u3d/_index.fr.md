...
{{% blocks/products/pf/agp/content h2="Comment convertir ATT en U3D en utilisant C#" %}}
 ...
 Afin de convertir ATT en U3D, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les programmeurs .NET peuvent facilement charger et convertir des fichiers ATT en U3D en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ATT via le constructeur de la classe Scene1. Créer une instance de AmfSaveOptions1. Définir U3D propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier U3D et l'objet de U3dSaveOptions1. Vérifier le fichier U3D résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion ATT à U3D C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ATT en U3D" sectionDescription="Consultez nos démos en direct pour [Conversion ATT à U3D](https://products.aspose.app/3d/conversion) avec les avantages suivants." >}}
