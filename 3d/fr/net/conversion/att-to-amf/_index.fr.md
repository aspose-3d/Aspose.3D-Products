---
title: Convertir ATT en AMF via C# 
url: /fr/net/conversion/att-to-amf/ 
description: Exemple de code pour la conversion de ATT à AMF C#. Utilisez l'exemple de code API pour les fichiers batch ATT vers la conversion AMF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ATT en AMF via C#" h2="Rendez ATT comme AMF sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir ATT en AMF en utilisant C#" %}}

 Afin de convertir ATT en AMF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ATT en AMF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les programmeurs .NET peuvent facilement charger et convertir des fichiers ATT en AMF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ATT via le constructeur de la classe Scene1. Créer une instance de AmfSaveOptions1. Définir AMF propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier AMF et l'objet de AmfSaveOptions1. Vérifier le fichier AMF résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion ATT à AMF C#" offSpacer="" %}}
...
// enregistrer ATT en tant que AMF 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ATT en AMF" sectionDescription="Consultez nos démos en direct pour [Conversion ATT à AMF](https://products.aspose.app/3d/conversion) avec les avantages suivants." >}}
