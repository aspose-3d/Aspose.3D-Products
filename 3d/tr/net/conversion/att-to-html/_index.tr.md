---
title: C# aracılığıyla ATT'i HTML'ye dönüştürün 
url: /tr/net/conversion/att-to-html/ 
description: ATT - HTML C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu ATT dosyaları HTML dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla ATT\'i HTML\'ye dönüştürün" h2="Herhangi bir 3D modelleme ve oluşturma yazılımı olmadan ATT\'i HTML olarak oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak ATT, HTML\'ye Nasıl Dönüştürülür" %}}

 ATT'i HTML'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla ATT\'i HTML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programcıları, yalnızca birkaç kod satırıyla ATT dosyalarını kolayca yükleyebilir ve HTML'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. ATT dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. Bir AmfSaveOptions örneği oluşturun1. Gelişmiş dönüştürme için HTML belirli özelliği ayarlayın1. Scene.Save yöntemini çağırın1. HTML dosya uzantısı ve Html5SaveOptions nesnesi ile çıktı yolunu iletin1. Belirtilen yolda ortaya çıkan HTML dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, ATT - HTML C# Dönüşümünü gösterir" offSpacer="" %}}
