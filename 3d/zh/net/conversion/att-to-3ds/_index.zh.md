---
title: 通过 C# 将 ATT 转换为 3DS 
url: /zh/net/conversion/att-to-3ds/ 
description: ATT 到 3DS C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 ATT 文件批量转换为 3DS。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 ATT 转换为 3DS" h2="将 ATT 渲染为 3DS，无需任何 3D 建模和渲染软件。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 ATT 转换为 3DS" %}}

 为了将 ATT 转换为 3DS，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 ATT 转换为 3DS 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 程序员只需几行代码即可轻松加载 ATT 文件并将其转换为 3DS。

{{% /blocks/products/pf/agp/text %}}

1. 通过 Scene 类的构造函数加载 ATT 文件1. 创建 AmfSaveOptions 的实例1. 为高级转换设置 3DS 个特定属性1. 调用 Scene.Save 方法1. 传递带有 3DS 文件扩展名和 Discreet3dsSaveOptions 对象的输出路径1. 检查指定路径的结果 3DS 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 ATT 到 3DS C# 转换" offSpacer="" %}}

```cs
// 在 Scene 对象中加载 ATT 
var document = new Aspose.ThreeD.Scene("template.att");
// 创建 Discreet3dsSaveOptions 的实例 
