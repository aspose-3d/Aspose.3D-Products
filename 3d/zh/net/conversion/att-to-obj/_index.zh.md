---
title: 通过 C# 将 ATT 转换为 OBJ 
url: /zh/net/conversion/att-to-obj/ 
description: ATT 到 OBJ C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 ATT 文件批量转换为 OBJ。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 ATT 转换为 OBJ" h2="将 ATT 渲染为 OBJ，无需任何 3D 建模和渲染软件。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 ATT 转换为 OBJ" %}}

 为了将 ATT 转换为 OBJ，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 ATT 转换为 OBJ 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 程序员只需几行代码即可轻松加载 ATT 文件并将其转换为 OBJ。

{{% /blocks/products/pf/agp/text %}}

1. 通过 Scene 类的构造函数加载 ATT 文件1. 创建 AmfSaveOptions 的实例1. 为高级转换设置 OBJ 个特定属性1. 调用 Scene.Save 方法1. 传递带有 OBJ 文件扩展名和 ObjSaveOptions 对象的输出路径1. 检查指定路径的结果 OBJ 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 ATT 到 OBJ C# 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 ATT 转换为 OBJ 的免费应用程序" sectionDescription="查看我们的现场演示 [ATT 到 OBJ 的转换](https://products.aspose.app/3d/conversion) 具有以下好处。" >}}
