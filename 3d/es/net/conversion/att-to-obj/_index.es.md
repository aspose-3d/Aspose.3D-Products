---
title: Convertir ATT a OBJ a través de C# 
url: /es/net/conversion/att-to-obj/ 
description: Ejemplo de código para la conversión de ATT a OBJ C#. Utilice el código de ejemplo API para la conversión por lotes de archivos ATT a OBJ dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ATT a OBJ a través de C#" h2="Renderizar ATT como OBJ sin ningún software de modelado y renderizado 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir ATT a OBJ usando C#" %}}

 Para convertir ATT a OBJ, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir ATT a OBJ a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los programadores de .NET pueden cargar y convertir fácilmente archivos ATT a OBJ con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo ATT a través del constructor de la clase Escena1. Crear una instancia de AmfSaveOptions1. Establecer OBJ propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con la extensión de archivo OBJ y el objeto de ObjSaveOptions1. Compruebe el archivo OBJ resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de ATT a OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir ATT a OBJ" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de ATT a OBJ](https://products.aspose.app/3d/conversion) con los siguientes beneficios." >}}
