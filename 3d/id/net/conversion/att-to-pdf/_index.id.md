---
title: Ubah ATT menjadi PDF melalui C# 
url: /id/net/conversion/att-to-pdf/ 
description: Kode contoh untuk konversi ATT ke PDF C#. Gunakan API kode contoh untuk file ATT batch ke konversi PDF dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ATT menjadi PDF melalui C#" h2="Render ATT sebagai PDF tanpa 3D perangkat lunak pemodelan dan rendering apa pun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ATT ke PDF Menggunakan C#" %}}

 Untuk mengonversi ATT menjadi PDF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi ATT ke PDF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pemrogram dapat dengan mudah memuat & mengonversi file ATT menjadi PDF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ATT melalui konstruktor kelas Scene1. Buat contoh AmfSaveOptions1. Tetapkan PDF properti khusus untuk konversi lanjutan1. Panggil Scene.Save method1. Lewati jalur keluaran dengan PDF ekstensi file & objek PdfSaveOptions1. Periksa file PDF yang dihasilkan pada jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan ATT ke PDF C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi ATT ke PDF" sectionDescription="Periksa demo langsung kami untuk [ATT menjadi PDF konversi](https://products.aspose.app/3d/conversion) dengan manfaat sebagai berikut." >}}
