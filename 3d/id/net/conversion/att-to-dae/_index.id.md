---
title: Ubah ATT menjadi DAE melalui C# 
url: /id/net/conversion/att-to-dae/ 
description: Kode contoh untuk konversi ATT ke DAE C#. Gunakan API kode contoh untuk file ATT batch ke konversi DAE dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ATT menjadi DAE melalui C#" h2="Render ATT sebagai DAE tanpa 3D perangkat lunak pemodelan dan rendering apa pun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ATT ke DAE Menggunakan C#" %}}

 Untuk mengonversi ATT menjadi DAE, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi ATT ke DAE melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pemrogram dapat dengan mudah memuat & mengonversi file ATT menjadi DAE hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ATT melalui konstruktor kelas Scene1. Buat contoh AmfSaveOptions1. Tetapkan DAE properti khusus untuk konversi lanjutan1. Panggil Scene.Save method1. Lewati jalur keluaran dengan DAE ekstensi file & objek DaeSaveOptions1. Periksa file DAE yang dihasilkan pada jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan ATT ke DAE C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi ATT ke DAE" sectionDescription="Periksa demo langsung kami untuk [ATT menjadi DAE konversi](https://products.aspose.app/3d/conversion) dengan manfaat sebagai berikut." >}}
