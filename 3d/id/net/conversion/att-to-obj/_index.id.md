---
title: Ubah ATT menjadi OBJ melalui C# 
url: /id/net/conversion/att-to-obj/ 
description: Kode contoh untuk konversi ATT ke OBJ C#. Gunakan API kode contoh untuk file ATT batch ke konversi OBJ dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ATT menjadi OBJ melalui C#" h2="Render ATT sebagai OBJ tanpa 3D perangkat lunak pemodelan dan rendering apa pun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ATT ke OBJ Menggunakan C#" %}}

 Untuk mengonversi ATT menjadi OBJ, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi ATT ke OBJ melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pemrogram dapat dengan mudah memuat & mengonversi file ATT menjadi OBJ hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ATT melalui konstruktor kelas Scene1. Buat contoh AmfSaveOptions1. Tetapkan OBJ properti khusus untuk konversi lanjutan1. Panggil Scene.Save method1. Lewati jalur keluaran dengan OBJ ekstensi file & objek ObjSaveOptions1. Periksa file OBJ yang dihasilkan pada jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan ATT ke OBJ C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi ATT ke OBJ" sectionDescription="Periksa demo langsung kami untuk [ATT menjadi OBJ konversi](https://products.aspose.app/3d/conversion) dengan manfaat sebagai berikut." >}}
