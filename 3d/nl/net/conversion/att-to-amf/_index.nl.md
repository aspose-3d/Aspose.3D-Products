---
title: Converteer ATT naar AMF via C# 
url: /nl/net/conversion/att-to-amf/ 
description: Voorbeeldcode voor conversie van ATT naar AMF C#. Gebruik API voorbeeldcode voor batch ATT-bestanden naar AMF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer ATT naar AMF via C#" h2="Geef ATT weer als AMF zonder enige 3D modellerings- en weergavesoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u ATT naar AMF converteert met C#" %}}

 Om ATT naar AMF te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ATT te converteren naar AMF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen gemakkelijk ATT bestanden laden en converteren naar AMF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad ATT bestand via de constructor van Scene klasse1. Maak een instantie van AmfSaveOptions1. Stel AMF specifieke eigenschappen in voor geavanceerde conversie1. Roep de Scene.Save-methode aan1. Geef het uitvoerpad door met AMF bestandsextensie & object van AmfSaveOptions1. Controleer het resulterende AMF-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont ATT naar AMF C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om ATT naar AMF te converteren" sectionDescription="Check onze live demo\'s voor [ATT naar AMF conversie](https://products.aspose.app/3d/conversion) met volgende voordelen." >}}
