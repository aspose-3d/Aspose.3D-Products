---
title: Converteer ATT naar 3DS via C# 
url: /nl/net/conversion/att-to-3ds/ 
description: Voorbeeldcode voor conversie van ATT naar 3DS C#. Gebruik API voorbeeldcode voor batch ATT-bestanden naar 3DS-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer ATT naar 3DS via C#" h2="Geef ATT weer als 3DS zonder enige 3D modellerings- en weergavesoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u ATT naar 3DS converteert met C#" %}}

 Om ATT naar 3DS te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ATT te converteren naar 3DS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen gemakkelijk ATT bestanden laden en converteren naar 3DS in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad ATT bestand via de constructor van Scene klasse1. Maak een instantie van AmfSaveOptions1. Stel 3DS specifieke eigenschappen in voor geavanceerde conversie1. Roep de Scene.Save-methode aan1. Geef het uitvoerpad door met 3DS bestandsextensie & object van Discreet3dsSaveOptions1. Controleer het resulterende 3DS-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont ATT naar 3DS C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om ATT naar 3DS te converteren" sectionDescription="Check onze live demo\'s voor [ATT naar 3DS conversie](https://products.aspose.app/3d/conversion) met volgende voordelen." >}}
