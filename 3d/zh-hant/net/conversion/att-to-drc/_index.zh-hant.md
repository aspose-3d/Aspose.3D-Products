---
title: 通過 C# 將 ATT 轉換為 DRC 
url: /zh-hant/net/conversion/att-to-drc/ 
description: ATT 到 DRC C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 ATT 文件批量轉換為 DRC。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 ATT 轉換為 DRC" h2="將 ATT 渲染為 DRC，無需任何 3D 建模和渲染軟件。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 ATT 轉換為 DRC" %}}

 為了將 ATT 轉換為 DRC，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 ATT 轉換為 DRC 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 程序員只需幾行代碼即可輕鬆加載 ATT 文件並將其轉換為 DRC。

{{% /blocks/products/pf/agp/text %}}

1. 通過 Scene 類的構造函數加載 ATT 文件1. 創建 AmfSaveOptions 的實例1. 為高級轉換設置 DRC 個特定屬性1. 調用 Scene.Save 方法1. 傳遞帶有 DRC 文件擴展名和 DrcSaveOptions 對象的輸出路徑1. 檢查指定路徑的結果 DRC 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 ATT 到 DRC C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 ATT 轉換為 DRC 的免費應用程序" sectionDescription="查看我們的現場演示 [ATT 到 DRC 的轉換](https://products.aspose.app/3d/conversion) 具有以下好處。" >}}
