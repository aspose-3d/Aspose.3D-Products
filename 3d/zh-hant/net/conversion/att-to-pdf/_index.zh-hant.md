...
description: ATT 到 PDF C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 ATT 文件批量轉換為 PDF。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序員只需幾行代碼即可輕鬆加載 ATT 文件並將其轉換為 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 通過 Scene 類的構造函數加載 ATT 文件1. 創建 AmfSaveOptions 的實例1. 為高級轉換設置 PDF 個特定屬性1. 調用 Scene.Save 方法1. 傳遞帶有 PDF 文件擴展名和 PdfSaveOptions 對象的輸出路徑1. 檢查指定路徑的結果 PDF 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 ATT 到 PDF C# 轉換" offSpacer="" %}}
