...
description: ATT 到 U3D C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 ATT 文件批量轉換為 U3D。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序員只需幾行代碼即可輕鬆加載 ATT 文件並將其轉換為 U3D。

{{% /blocks/products/pf/agp/text %}}

1. 通過 Scene 類的構造函數加載 ATT 文件1. 創建 AmfSaveOptions 的實例1. 為高級轉換設置 U3D 個特定屬性1. 調用 Scene.Save 方法1. 傳遞帶有 U3D 文件擴展名和 U3dSaveOptions 對象的輸出路徑1. 檢查指定路徑的結果 U3D 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 ATT 到 U3D C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 ATT 轉換為 U3D 的免費應用程序" sectionDescription="查看我們的現場演示 [ATT 到 U3D 的轉換](https://products.aspose.app/3d/conversion) 具有以下好處。" >}}
