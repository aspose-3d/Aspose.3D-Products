...
{{% blocks/products/pf/agp/content h2="Como converter ATT em 3DS usando C#" %}}

 Para converter ATT em 3DS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ATT em 3DS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos ATT para 3DS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo ATT por meio do construtor da classe Scene1. Crie uma instância de AmfSaveOptions1. Defina 3DS propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo 3DS e objeto de Discreet3dsSaveOptions1. Verifique o arquivo 3DS resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de ATT para 3DS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter ATT em 3DS" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de ATT para 3DS](https://products.aspose.app/3d/conversion) com os seguintes benefícios." >}}
