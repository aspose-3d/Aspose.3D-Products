---
title: Converter ATT em U3D via C# 
url: /pt/net/conversion/att-to-u3d/ 
description: Código de amostra para conversão de ATT para U3D C#. Use API código de exemplo para arquivos ATT em lote para conversão U3D em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ATT em U3D via C#" h2="Renderize ATT como U3D sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ATT em U3D usando C#" %}}

 Para converter ATT em U3D, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ATT em U3D via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos ATT para U3D em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo ATT por meio do construtor da classe Scene1. Crie uma instância de AmfSaveOptions1. Defina U3D propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo U3D e objeto de U3dSaveOptions1. Verifique o arquivo U3D resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de ATT para U3D C#" offSpacer="" %}}
