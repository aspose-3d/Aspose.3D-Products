---
title: Converter ATT em PDF via C# 
url: /pt/net/conversion/att-to-pdf/ 
description: Código de amostra para conversão de ATT para PDF C#. Use API código de exemplo para arquivos ATT em lote para conversão PDF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ATT em PDF via C#" h2="Renderize ATT como PDF sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ATT em PDF usando C#" %}}

 Para converter ATT em PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ATT em PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos ATT para PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo ATT por meio do construtor da classe Scene1. Crie uma instância de AmfSaveOptions1. Defina PDF propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo PDF e objeto de PdfSaveOptions1. Verifique o arquivo PDF resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de ATT para PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter ATT em PDF" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de ATT para PDF](https://products.aspose.app/3d/conversion) com os seguintes benefícios." >}}
