---
title: Converter ATT em OBJ via C# 
url: /pt/net/conversion/att-to-obj/ 
description: Código de amostra para conversão de ATT para OBJ C#. Use API código de exemplo para arquivos ATT em lote para conversão OBJ em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ATT em OBJ via C#" h2="Renderize ATT como OBJ sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ATT em OBJ usando C#" %}}

 Para converter ATT em OBJ, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ATT em OBJ via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos ATT para OBJ em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo ATT por meio do construtor da classe Scene1. Crie uma instância de AmfSaveOptions1. Defina OBJ propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo OBJ e objeto de ObjSaveOptions1. Verifique o arquivo OBJ resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de ATT para OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter ATT em OBJ" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de ATT para OBJ](https://products.aspose.app/3d/conversion) com os seguintes benefícios." >}}
